...
const resultsFile = 'corona2.json';
const statsFile = 'corona2/corona2_stats.json';
const storedRecordsFile = 'corona2/corona2_postprocessed.json';
...
var baseUrl = 'https://api.minnen.se/api/responses/?topic=c76f8cd5-9322-46de-8288-af9a5a6dd619&order=created&limit=10';
...
const newFilename = 'corona2/corona2_postprocessed.json';
...
await Deno.writeTextFile('corona2/corona2_stats.json', JSON.stringify(stats, null, 2));
await Deno.writeTextFile('corona2/newRecords.json', JSON.stringify(newRecords, null, 2));
//await Deno.writeTextFile('corona/index.html', indexHtml);
await Deno.writeTextFile('corona2/corona2_geojson.json', JSON.stringify(geoJson, null, 2));
await Deno.writeTextFile('corona/build/corona2_geojson.json', JSON.stringify(geoJson, null, 2));
